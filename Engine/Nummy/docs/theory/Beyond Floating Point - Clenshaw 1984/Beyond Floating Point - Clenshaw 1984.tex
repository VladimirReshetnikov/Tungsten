...
\begin{abstract}
A new number system is proposed for computer arithmetic based on iterated exponential functions. The main advantage is to eradicate overflow and underflow, but there are several other advantages and these are described and discussed.\\[0pt]
...
\section*{2. Generalized Exponentials and Logarithms}
Let $x$ be any real number and\\
\includegraphics[max width=\textwidth, alt={}, center]{dfec145f-bc98-40aa-ab18-12f8809ece6f-02_208_289_1882_634}

\footnotetext{${ }^{1}$ See, for example, detailed discussions of very large and very small numbers in [15].\\
...
or equivalently,\\
\includegraphics[max width=\textwidth, alt={}, center]{dfec145f-bc98-40aa-ab18-12f8809ece6f-03_213_322_2072_612}\\
...
\section*{3. Advantages of the li System}
...
\includegraphics[max width=\textwidth, alt={}, center]{dfec145f-bc98-40aa-ab18-12f8809ece6f-06_211_230_300_667}
...
\footnotetext{${ }^{7}$ Another notation that is sometimes useful is $x=1(\alpha) \bar{x}$. Here $1(\alpha)$ means some number that approximates 1 to $\operatorname{rp}(\alpha)$. This is due to Pryce [16].
...
As Littlewood [10, p. 103] has pointed out, very large numbers enjoy some interesting arithmetical properties; our li notation proves convenient for their\\[0pt]
...
\section*{4. Other Distinguished Points}
...
\footnotetext{${ }^{8}$ That 1s, chopping or rounding errors.
}
acknowledgments. The authors are pleased to acknowledge valuable comments by Dr. D. W. Lozier, Dr. P. L. Walker, and the referees.

\section*{REFERENCES}
\begin{enumerate}
  \item Brent, R.P. A Fortran multiple-precision arithmetic package. ACM Trans. Math Softw 4, 1 (Mar. 1978), 57-70.
  \item Brent, R.P. Algorithm 524. MP, A Fortran multiple-precision arithmetic package. ACM Trans. Math Softw. 4, 1 (Mar. 1978), 71-81.
  \item Clenshaw, C.W., and Olver, F.W.J. An unrestricted algorithm for the exponential function. SIAM J. Numer Anal 17 (Apr. 1980), 310-331.
  \item Cody, W.J., Jr., and Waite, W. Sofiware Manual for the Elementary Functions Prentice-Hall, Englewood Cliffs, N.J., 1980.
  \item Coonen, J.T. Underflow and the denormalized numbers. Computer 14 (Mar. 1981), 75-87.
  \item Dirac, P.A.M. Directions in Physics. Wiley-Interscience, New York, 1978.
  \item Hardy, G.H. Orders of Infinity Cambridge University Press, New York, 1924.
  \item Kahan, W. Implementation of Algorithms. Parts I and II. National Technical Information Service, U.S. Department of Commerce, Springfield, Va., 1973.
  \item Kneser, H. Reelle analytische Losungen der Gleichung $\phi(\phi(x))=e^{x}$ und verwandter Funktionalgleichung. J Reine Angew. Math. 187 (1948), 56-67.
  \item Littlewood, J.E. A Mathematician's Miscellany. Methuen, London, 1953.
  \item Lozier, D.W., and Smith, J.M. Algorithm 567. Extended-range arithmetic and normalized Legendre polynomials. ACM Trans. Math Softw 7, 1 (Mar. 1981), 141-146.
  \item Matula, D.W., and Kornerup, P. Foundations of finite precision rational anthmetic. In Fundamentals of Numerical Computation (Computer-Oriented Numerical Analysis), G. Alefeld and R.D. Grigorieff, Eds. Computing, Suppl. 2 (1980), 85-111.
  \item Olver, F.W.J. A new approach to error anthmetic. SIAM J Numer. Anal 15 (Apr. 1978), 368-393.
  \item Olver, F.W.J. Further developments of rp and ap error analysis. IMA $J$ Numer Anal. 2 (1982), 249-274.
  \item Parlett, B., Ed. Special Issue on the Proposed IEEE Floating-Point Standard. ACM SIGNUM Newsletter (Oct. 1979), 1-32.
  \item Pryce, J.D. Round-off error analysis with fewer tears. Bull Inst Math Appl 17(Feb./Mar. 1981), 40-47.
  \item Smith, J.M., Olver, F.W.J., and Lozier, D.W. Extended-range arithmetic and normalized Legendre polynomials. ACM Trans Math Softw 7, 1 (Mar. 1981), 93-105.
  \item Wilkinson, J.H. Rounding errors in algebraic processes. National Physical Laboratory, Notes on Applied Science No. 32. H. M. Stationery Office, London, 1963.
\end{enumerate}
