...
checkEvaluator = do
  let inputCases =
        ...
        , ("held session forms", "{OwnValues[1 + 2], With[{x = 1 + 2}, x], Module[{x = 1 + 2}, x], Block[{x = 1 + 2}, x], InheritedBlock[{x = 1 + 2}, x], Internal`InheritedBlock[{x = 1 + 2}, x], Return[1 + 2], Return[1 + 2, Module]}", "List[OwnValues[Plus[1, 2]], With[List[Set[x, Plus[1, 2]]], x], Module[List[Set[x, Plus[1, 2]]], x], Block[List[Set[x, Plus[1, 2]]], x], InheritedBlock[List[Set[x, Plus[1, 2]]], x], Internal`InheritedBlock[List[Set[x, Plus[1, 2]]], x], Return[Plus[1, 2]], Return[Plus[1, 2], Module]]")
