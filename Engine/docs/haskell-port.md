...
- Updated (UTC): 2026-07-22T02:39:40Z
- Repository HEAD: 94fba7379fd83f912d6ca8ea30578d0c1fc6665c
...
- subvalues/upvalues, symbol and three-argument `Function` attributes, nested positional-slot scope
  diagnostics, session-aware callback evaluation for aggregation reducers beyond the selection,
  map, sort, and pattern/rewrite families, the full string-pattern, base
