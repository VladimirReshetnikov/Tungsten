...
- Updated (UTC): 2026-07-22T02:27:36Z
- Repository HEAD: 1d83b2fa73f4463634802894feafe20e5f529743
...
- subvalues/upvalues, symbol and three-argument `Function` attributes, nested positional-slot scope
  ...
  reducers beyond the selection and map/sort families, held session-aware pattern/rewrite
  arguments and effectful `Condition`/`PatternTest` callbacks, the full string-pattern, base
