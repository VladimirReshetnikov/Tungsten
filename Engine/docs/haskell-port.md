...
- Updated (UTC): 2026-07-18T23:03:51Z
- Repository HEAD: 8d5609b9954d1f1e9f9d5b0f186c64edc942ed5e
...
- subvalues/upvalues, symbol and three-argument `Function` attributes, nested positional-slot scope
  diagnostics, session-aware nested pattern tests, remaining `For`/`While` and broader loop control, real-valued
