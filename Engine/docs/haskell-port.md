...
- Updated (UTC): 2026-07-18T20:49:17Z
- Repository HEAD: 2dfdcc4aedcfea593a8a881bebc2b797e3bcaedc
...
| Sessions | Immutable immediate/delayed symbol own-values, assignment and updates, unset/clear, sequential state, session-aware held control flow, Block-scoped held `Table` iteration over counts/exact ranges/value lists/nested dependent specifications, and fresh-session stateless command evaluation |
