...
- Updated (UTC): 2026-07-22T01:46:08Z
- Repository HEAD: 5df91c268e35cc9f08a84caed0e85a7b82899387
...
- subvalues/upvalues, symbol and three-argument `Function` attributes, nested positional-slot scope
  ...
  invocation traces and `SameTest` semantics for `SortBy`/`ReverseSortBy`, the full string-pattern
  and character-encoding surface, broader loop and jump control, real-valued iteration,
